        ...
        <div class="collapse navbar-collapse show" id="navbarTogglerDemo2">
          <ul class="navbar-nav me-auto mb-2 mb-xl-0">
            ...
            if (    isset($_SESSION['user_id']) && isset($_SESSION['user_type'])    
             && ($_SESSION['user_type'] == 'Commercial' || $_SESSION['user_type'] == 'Admin' || $_SESSION['user_type'] == 'TechnicienSAV') ) {
            ...
            echo ' <li class="nav-item">
              <a class="nav-link" href="formulaire_retour.php">Formulaire de Retour</a>
            </li>';
            }
